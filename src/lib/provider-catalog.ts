...
export const PROVIDER_CATALOG: Record<ProviderKind, ProviderMeta> = {
  ...
  deepseek: {
    ...
    shortDescription: {
      zh: "支持 Chat 和 Reasoner。DeepSeek 本身不内置联网能力，开启联网时系统会通过外部搜索增强为其提供实时资料；推荐填写 Tavily，也支持回退到 Bing RSS、Google News RSS、Wikipedia 等公开来源。",
      en: "Supports Chat and Reasoner. DeepSeek has no built-in web search — when search is enabled, the app uses external search augmentation for live evidence. Tavily is recommended, with public fallbacks such as Bing RSS, Google News RSS, and Wikipedia.",
    },
    apiKeyHelp: {
    ...
    modelDocsUrl: "https://api-docs.deepseek.com/",
  ...
  xai: {
    ...
    modelDocsUrl: "https://docs.x.ai/docs/models/overview",
